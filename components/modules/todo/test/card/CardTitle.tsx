...
const BoardListCardTitle = ({ card }: { card: CardType }) => {
	...
	return isEditing ? (
		<Input
			...
			className="shadow-0 h-auto rounded-none border-0 !bg-transparent p-0 text-base !shadow-none focus:outline-none focus-visible:outline-none focus-visible:ring-0 focus-visible:ring-offset-0 dark:!bg-transparent"
		/>
	) : (
		<span
